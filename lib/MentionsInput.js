...
var propTypes = {
   ...
   */
  submitBtn: _propTypes2.default.bool,
  ...
  showHighlights: _propTypes2.default.bool,
...
var MentionsInput = (_temp = _class = function (_React$Component) {
  ...
  this.renderTextarea = function (props) {
    return _react2.default.createElement(_reactAutosizeTextarea2.default, _extends({
      ref: function ref(el) {
  ...
  this.renderSubmit = function (props) {
    ...
    return _react2.default.createElement('input', _extends({ type: 'submit', value: 'submit', className: 'enter' }, props, { onClick: onClickSubmit }));
  };
